...
export class GameLeftSidebar extends LitElement implements Layer {
  ...
  render() {
    return html`
      <aside
        class=${`submarine-panel military-panel fixed top-[50px] lg:top-[10px] left-0 z-[1000] flex flex-col max-h-[calc(100vh-80px)] overflow-y-auto p-2 transition-transform duration-300 ease-out transform ${
